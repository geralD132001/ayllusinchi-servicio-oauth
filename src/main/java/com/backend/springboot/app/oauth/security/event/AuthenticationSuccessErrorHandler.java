package com.backend.springboot.app.oauth.security.event;

import brave.Tracer;
import com.backend.springboot.app.commons.usuarios.models.entity.Usuario;
import com.backend.springboot.app.oauth.services.IUsuarioService;
...
public class AuthenticationSuccessErrorHandler implements AuthenticationEventPublisher {
    ...
    public void publishAuthenticationSuccess(Authentication authentication) {
        ...
        /* if(authentication.getName().equalsIgnoreCase("ayllusinchiapp")){
            return;
        }*/
    ...
    public void publishAuthenticationFailure(AuthenticationException exception, Authentication authentication) {
        ...
        try {
            ...
            log.info("Intentos acutal es de: " + usuario.getIntentos());
